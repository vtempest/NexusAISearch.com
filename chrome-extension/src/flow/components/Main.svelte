<script lang="ts">
	...
	import { popups, closePopup, openPopup, type Popup as PopupType } from '../models/popup';
	...
	import {
		...
		parseJoinLink,
		type Broadcast
	} from '../models/sharingConnection';
	import Share from '../components/Share.svelte';
	import CloseWindow from '../components/CloseWindow.svelte';
