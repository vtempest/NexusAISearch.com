<script lang="ts">
	...
	import type { FlowId, Nodes } from '../models/node';
	import { onDestroy, onMount } from 'svelte';
	import { activeMouse, flowsChange, nodes, pendingAction } from '../models/store';
	import { createKeyDownHandler } from '../models/key';
	import Prelude from '../components/Prelude.svelte';
	import { loadNodes } from '../models/file';
	import Timers from '../components/Timers.svelte';
	import Help from '../components/Help.svelte';
	import { settings } from '../models/settings';
	import SideDoc from '../components/SideDoc.svelte';
	import { history } from '../models/history';
	import { focusId, lastFocusIds, selectedFlowId } from '../models/focus';
	import { isChangelogVersionCurrent } from '../models/version';
	import { addNewFlow, deleteFlow, moveFlow, replaceNodes } from '../models/nodeDecorateAction';
	import { currentDebateStyle, type DebateStyleFlow } from '../models/debateStyle';
