...
export function extractAuthor(document) {
  ...
  if (typeof author == "undefined") {
    ...
    if (arrAuthors.length <= 0) {
      arrAuthors = document.getElementsByName("Author");
    } //Try Author
    if (arrAuthors.length <= 0) {
      arrAuthors = document.getElementsByName("sailthru.author");
    } //Try sailtru.author
    if (arrAuthors.length <= 0) {
      arrAuthors = document.getElementsByName("byl");
    } //Try byl
    if (arrAuthors.length <= 0) {
      arrAuthors = document.getElementsByName("byline");
    } //Try byline
    if (arrAuthors.length <= 0) {
      arrAuthors = document.getElementsByName("DC.creator");
    } //Try DC.creator
    if (arrAuthors.length <= 0) {
