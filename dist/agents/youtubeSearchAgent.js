...
const createBasicYoutubeSearchRetrieverChain = (llm) => {
    return runnables_1.RunnableSequence.from([
        prompts_1.PromptTemplate.fromTemplate(basicYoutubeSearchRetrieverPrompt),
        llm,
        strParser,
...
const createBasicYoutubeSearchAnsweringChain = (llm, embeddings) => {
...
const basicYoutubeSearch = (query, history, llm, embeddings) => {
    ...
    try {
        ...
        logger_1.default.error(`Error in youtube search: ${err}`);
    }
    return emitter;
};
const handleYoutubeSearch = (message, history, llm, embeddings) => {
    const emitter = basicYoutubeSearch(message, history, llm, embeddings);
    return emitter;
};
exports.default = handleYoutubeSearch;
